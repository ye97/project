function [vecs,n,lambda] = computeDescriper(srcCloud,opt)
...
% end
 ...
 %% compute descriptors for seed points in the source point cloud with distance in r 
...
%% compute the k nearest points 
[normals, curvature]  = findPointNormals(srcCloud,opt.k)

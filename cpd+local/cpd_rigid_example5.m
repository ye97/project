...
opt.corresp=0;      % do not compute the correspondence vector at the end of registration (default：0). Can be quite slow for large data sets.
...
err_comp_twoviews(R,0,Transform.R,Transform.t,1)
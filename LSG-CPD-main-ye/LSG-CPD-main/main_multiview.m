...
if strcmp(model_name, 'bunny') || strcmp(model_name, 'Dragon')
    num_pc = 4;
else
...
for i = 1 : num_pc -1
    xform_rel{i} = LSGCPD(pc{i+1}, pc{i}, 'outlierRatio', 0.1);
    save(sprintf("xform_rel{%d}", i) )
end
